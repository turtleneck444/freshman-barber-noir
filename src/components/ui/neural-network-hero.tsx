...
export default function BarbershopNeuralHero({
  title,
  description,
  badgeText = "Premium Barbering",
  badgeLabel = "New",
  ctaButtons = [
    { text: "Book Appointment", href: "#booking", primary: true },
    { text: "View Services", href: "#services" }
  ],
  microDetails = ["15+ Years Experience", "Expert Barbers", "Premium Services"]
}: HeroProps) {
  ...
  return (
    <section ref={sectionRef} className="relative h-screen w-screen overflow-hidden" id="home">
      <ShaderBackground />
